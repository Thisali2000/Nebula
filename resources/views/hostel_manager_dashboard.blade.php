...
document.addEventListener("DOMContentLoaded", function() {
    ...
    $("#searchInput").keyup(function() {
        $.get("{{ route('api.hostel.manager.search') }}", {search: this.value}, renderActionList);
    });
    ...
    $("#applyFilters").click(() => {
        ...
        $.get("{{ route('api.hostel.manager.filter') }}", params, renderActionList);
    });
...
function loadOverview() {
    ...
    $.get("{{ route('api.hostel.manager.overview') }}", {year, month}, function(data) {
...
function loadActionList() {
    $.get("{{ route('api.hostel.manager.action.list') }}", renderActionList);
}

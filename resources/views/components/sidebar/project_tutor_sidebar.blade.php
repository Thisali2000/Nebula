<div>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar>
        <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link {{ request()->routeIs('students.view') ? 'active' : '' }}"
            ...
            <li class="sidebar-item">
                <a class="sidebar-link {{ request()->routeIs('project.clearance.management') ? 'active' : '' }}"
                   href="{{ route('project.clearance.management') }}">

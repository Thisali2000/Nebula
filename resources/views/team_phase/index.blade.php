                          ...
                          <div class="card-body py-2">
                            <div class="d-flex justify-content-between align-items-start">
                              <div class="flex-grow-1">
                                <h6 class="mb-1 fw-semibold text-dark" style="font-size: 0.9rem;">{{ $supervisor['name'] }}</h6>
                                <small class="text-muted" style="font-size: 0.8rem;">{{ $supervisor['designation'] }}</small>
                              </div>
                              @if($isDeveloper)

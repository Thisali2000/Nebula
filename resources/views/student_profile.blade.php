      ...
      <div class="p-4 rounded shadow w-100 bg-white">
        ...
        <div class="container mt-4 rounded border p-3" id="profileSection" style="{{ isset($student) ? '' : 'display:none;' }}">
          ...
          <ul class="nav nav-tabs" id="studentTabs">
            ...
            <li class="nav-item"><a class="nav-link" id="payment-tab" data-bs-toggle="tab" href="#payment">Payment</a></li>
          ...
          <div class="tab-content mt-2">
            ...
            <div class="tab-pane fade" id="parent">
              <div class="mb-3 row align-items-center mx-3">
                ...
                <div class="col-sm-9"><input type="text" class="form-control" id="parentName" value="{{ $student->parent->guardian_name ?? '' }}" readonly></div>
              </div>
              <div class="mb-3 row align-items-center mx-3">
                <label for="parentProfession" class="col-sm-3 col-form-label fw-bold">Profession</label>
                <div class="col-sm-9"><input type="text" class="form-control" id="parentProfession" value="{{ $student->parent->guardian_profession ?? '' }}" readonly></div>
              </div>
              <div class="mb-3 row align-items-center mx-3">
                <label for="parentContactNo" class="col-sm-3 col-form-label fw-bold">Contact Number</label>
                <div class="col-sm-9"><input type="tel" class="form-control" id="parentContactNo" value="{{ $student->parent->guardian_contact_number ?? '' }}" readonly></div>
              </div>
              <div class="mb-3 row align-items-center mx-3">
                <label for="parentEmail" class="col-sm-3 col-form-label fw-bold">Email</label>
                <div class="col-sm-9"><input type="email" class="form-control" id="parentEmail" value="{{ $student->parent->guardian_email ?? '' }}" readonly></div>
              </div>
              <div class="mb-3 row align-items-center mx-3">
                <label for="parentAddress" class="col-sm-3 col-form-label fw-bold">Address</label>
                <div class="col-sm-9"><textarea class="form-control" id="parentAddress" rows="2" readonly>{{ $student->parent->guardian_address ?? '' }}</textarea></div>
              </div>
              <div class="mb-3 row align-items-center mx-3">
                <label for="parentEmergencyContact" class="col-sm-3 col-form-label fw-bold">Emergency Contact Number</label>
                <div class="col-sm-9"><input type="text" class="form-control bg-danger text-white" id="parentEmergencyContact" value="{{ $student->parent->emergency_contact_number ?? '' }}" readonly></div>
              </div>
              <div class="mt-4 mb-3">
            ...
            <div class="tab-pane fade" id="payment">
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <select id="paymentCourseSelect" class="form-select"><option value="">Select a course</option></select>
                </div>
                <div class="col-md-6">
                  <label for="paymentIntakeSelect" class="form-label fw-bold">Select Intake</label>
                  <select id="paymentIntakeSelect" class="form-select" disabled><option value="">Select an intake</option></select>
                </div>
              </div>
              <div id="paymentTableWrapper" style="display:none;">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="card">
                      <div class="card-header bg-primary text-white"><h6 class="mb-0">Payment Summary</h6></div>
                      <div class="card-body">
                        <div class="row mb-2"><div class="col-6"><strong>Total Fee:</strong></div><div class="col-6" id="totalFee">-</div></div>
                        <div class="row mb-2"><div class="col-6"><strong>Paid Amount:</strong></div><div class="col-6" id="paidAmount">-</div></div>
                        <div class="row mb-2"><div class="col-6"><strong>Balance:</strong></div><div class="col-6" id="balance">-</div></div>
                        <div class="row mb-2"><div class="col-6"><strong>Status:</strong></div><div class="col-6" id="paymentStatus">-</div></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="card">
                      <div class="card-header bg-success text-white"><h6 class="mb-0">Payment History</h6></div>
                      <div class="card-body"><div id="paymentHistory"><p class="text-muted">Select a course and intake to view payment history.</p></div></div>
                    </div>
                  </div>
                </div>
                <div class="mt-3">
                  ...
                  <table class="table table-bordered">
                    <thead class="bg-info text-white">
                      <tr><th>Due Date</th><th>Amount</th><th>Status</th><th>Payment Date</th><th>Receipt</th></tr>
                    </thead>
                    <tbody id="paymentScheduleTableBody"></tbody>
                  </table>
                </div>
              </div>
            </div>

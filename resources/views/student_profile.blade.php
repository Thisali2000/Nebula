                  ...
                  <div class="tab-pane fade" id="other-info">
                    ...
                    @if(isset($student->other_information))
                      ...
                      <div class="mb-3 row align-items-center mx-3">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="{{ $student->other_information->institute ?? '' }}">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">
                        <label class="col-sm-3 col-form-label fw-bold">Field of Study</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="{{ $student->other_information->field_of_study ?? '' }}">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">
                        <label class="col-sm-3 col-form-label fw-bold">Job Title</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="{{ $student->other_information->job_title ?? '' }}">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">
                        <label class="col-sm-3 col-form-label fw-bold">Workplace</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="{{ $student->other_information->workplace ?? '' }}">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">

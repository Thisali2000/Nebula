            ...
            <form id="otherInformationForm" class="p-4 rounded w-100 bg-white mt-2" enctype="multipart/form-data">
                ...
                <div class="mb-3 row mx-3 align-items-center">
                  ...
                  <div class="col-sm-9">
                    <div class="form-check form-check-inline">
                      <input value="true" class="form-check-input" type="radio" id="continueYes" name="continueStudies">
                      <label class="form-check-label" for="continueYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input value="false" class="form-check-input" type="radio" id="continueNo" name="continueStudies" checked>
              ...
              <div class="mb-4">
                <div class="mb-3 row mx-3 align-items-center">
                  ...
                  <div class="col-sm-9">
                    <div class="form-check form-check-inline">
                      <input value="true" class="form-check-input" type="radio" id="employeeYes" name="currentlyEmployee">
                      <label class="form-check-label" for="employeeYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input value="false" class="form-check-input" type="radio" id="employeeNo" name="currentlyEmployee" checked>

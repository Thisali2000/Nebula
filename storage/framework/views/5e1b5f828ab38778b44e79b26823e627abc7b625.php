        ...
        <div class="container mt-4 rounded border p-3" id="profileSection" style="display: none;">
          <input type="hidden" id="studentIdHidden" value="">
                      <ul class="nav nav-tabs" id="studentTabs">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="other-info-tab" data-bs-toggle="tab" href="#other-info">Other Information</a>
                        </li>
                      </ul>
                  ...
                  <div class="tab-pane fade" id="other-info">
                    ...
                    <?php if(isset($student->other_information)): ?>
                      ...
                      <div class="mb-3 row align-items-center mx-3">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="<?php echo e($student->other_information->institute ?? ''); ?>">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">
                        <label class="col-sm-3 col-form-label fw-bold">Field of Study</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="<?php echo e($student->other_information->field_of_study ?? ''); ?>">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">
                        <label class="col-sm-3 col-form-label fw-bold">Job Title</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="<?php echo e($student->other_information->job_title ?? ''); ?>">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">
                        <label class="col-sm-3 col-form-label fw-bold">Workplace</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" readonly value="<?php echo e($student->other_information->workplace ?? ''); ?>">
                        </div>
                      </div>
                      <div class="mb-3 row align-items-center mx-3">
...
function showErrorMessage(message) {
  ...
  function populateStudentProfile(student) {
    ...
    let otherInfo = student.other_information;
    let $otherInfoTab = $('#other-info');
    $otherInfoTab.empty();
    $otherInfoTab.append('<h5 class="mt-4 mb-3 fw-bold">Other Information</h5>');
    if (otherInfo) {
        $otherInfoTab.append(`
            <div class="mb-3 row align-items-center mx-3">
                <label class="col-sm-3 col-form-label fw-bold">Disciplinary Issues</label>
                <div class="col-sm-9">
                    <textarea class="form-control" rows="2" readonly>${otherInfo.disciplinary_issues || ''}</textarea>
                </div>
            </div>
            <div class="mb-3 row align-items-center mx-3">
                <label class="col-sm-3 col-form-label fw-bold">Disciplinary Document</label>
                <div class="col-sm-9">
                    ${otherInfo.disciplinary_issue_document
                        ? `<a href="/storage/${otherInfo.disciplinary_issue_document}" target="_blank">View Document</a>`
                        : '<span class="text-muted">Not uploaded</span>'}
                </div>
            </div>
            <div class="mb-3 row align-items-center mx-3">
                <label class="col-sm-3 col-form-label fw-bold">Institute</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" readonly value="${otherInfo.institute ? otherInfo.institute : '-'}">
                </div>
            </div>
            <div class="mb-3 row align-items-center mx-3">
                <label class="col-sm-3 col-form-label fw-bold">Field of Study</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" readonly value="${otherInfo.field_of_study ? otherInfo.field_of_study : '-'}">
                </div>
            </div>
            <div class="mb-3 row align-items-center mx-3">
                <label class="col-sm-3 col-form-label fw-bold">Job Title</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" readonly value="${otherInfo.job_title ? otherInfo.job_title : '-'}">
                </div>
            </div>
            <div class="mb-3 row align-items-center mx-3">
                <label class="col-sm-3 col-form-label fw-bold">Workplace</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" readonly value="${otherInfo.workplace ? otherInfo.workplace : '-'}">
                </div>
            </div>
            <div class="mb-3 row align-items-center mx-3">
                <label class="col-sm-3 col-form-label fw-bold">Other Information</label>
                <div class="col-sm-9">
                    <textarea class="form-control" rows="2" readonly>${otherInfo.other_information ? otherInfo.other_information : '-'}</textarea>
                </div>
            </div>
        `);
    } else {
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nebula fin/Nebula/resources/views/student_profile.blade.php ENDPATH**/ ?>
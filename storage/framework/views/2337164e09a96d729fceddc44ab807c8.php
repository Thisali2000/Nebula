<div>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar>
        <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link <?php echo e(Route::currentRouteName() == 'payment.clearance' ? 'active' : ''); ?>"
                   href="<?php echo e(route('payment.clearance')); ?>">
...
<?php /**PATH D:\SLT\Welisara\Nebula\resources\views/components/sidebar/bursar_sidebar.blade.php ENDPATH**/ ?>
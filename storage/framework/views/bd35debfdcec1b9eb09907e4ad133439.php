<div>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar>
        <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link <?php echo e(Route::currentRouteName() == 'payment.index' ? 'active' : ''); ?>"
            ...
            <li class="sidebar-item">
                <a class="sidebar-link <?php echo e(Route::currentRouteName() == 'payment.discount.page' ? 'active' : ''); ?>"
            ...
            <li class="sidebar-item">
                <a class="sidebar-link <?php echo e(Route::currentRouteName() == 'late.payment.index' ? 'active' : ''); ?>"
            ...
            <?php if(RoleHelper::hasPermission($role, 'latefee.approval')): ?>
            <li class="sidebar-item">
            ...
            <li id="teamNebulaLink" class="text-center mb-3" style="opacity: 0.8; font-size: 13px;">
                <a href="<?php echo e(route('team.phase.index')); ?>"
                   class="text-decoration-none d-inline-block py-1 px-2 rounded
                          <?php echo e(Route::currentRouteName() == 'team.phase.index' ? 'bg-light text-primary fw-semibold shadow-sm' : 'text-muted'); ?>"
...
<?php /**PATH D:\SLT\Welisara\Nebula\resources\views/components/sidebar/student_counselor_sidebar.blade.php ENDPATH**/ ?>